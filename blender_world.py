...
def process_world_json(opt):

    print("Processing world JSON...")
    ...
    for entry in doors_windows:
        ...
        try:
            ...
            print("#"*50)
            print("SUBTRACTING ERROR", entry['wall0'])
            print("#"*50)
        ...
        try:
            ...
            print("#"*50)
            print("SUBTRACTING ERROR", entry['wall1'])
            print("#"*50)
        ...
        if "door" in entry['id'].lower():
            ...
            # load the asset
            print(f"{opt.content}/{entry['id'].split('|')[0]}s/{entry['assetId'].lower()}.glb")
            ...
            if asset_loaded:
                ...
                add_material(asset_loaded,f"{opt.content}/textures/Wood080/",add_uv =True,material_pos=0)
                if rotate:
                    bpy.context.view_layer.objects.active = asset_loaded
                    bpy.ops.transform.rotate(value=math.radians(90), orient_axis='Z')
